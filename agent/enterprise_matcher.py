...
INDUSTRY_DIMENSIONS = {
    ...
    # ---- 生物医药（轻资产：GMP/MAH/集采替代生产线/产能） ----
    "生物医药": {
        "tech": {
            "high": ["创新药", "审评审批", "MAH", "医疗器械注册人",
                     "临床试验", "细胞治疗", "基因治疗", "中药现代化"],
            "medium": ["IND", "NDA", "CDE", "一致性评价",
                       "药品注册", "生物制品"],
        },
        "prod": {
            "high": ["GMP", "GSP", "原料药", "冷链物流",
                     "药品定价", "委托生产"],
            "medium": ["药品生产许可", "洁净车间", "CRO", "CDMO",
                       "药品质量"],
        },
        "mkt": {
            "high": ["医保目录", "集采", "商业健康险", "互联网医疗"],
            "medium": ["DRG", "DIP", "医保支付", "医疗服务",
                       "药品集中采购"],
        },
        "cap": {
            "high": ["港股18A", "科创板第五套", "生物医药产业基金"],
            "medium": ["创新药投资", "生物医药基金", "MAH融资"],
        },
    },
    # ---- 数字经济（轻资产：数据中心/算力替代工厂/用地） ----
    "数字经济": {
        "tech": {
            "high": ["算力基础设施", "数据要素", "AI大模型", "人工智能",
                     "大模型", "数据安全"],
            "medium": ["开源生态", "算法", "隐私计算", "工业互联网",
                       "数字孪生"],
        },
        "prod": {
            "high": ["数据中心", "网络基础设施", "数据跨境",
                     "东数西算", "数字基础设施"],
            "medium": ["5G基站", "边缘计算", "物联网", "云计算",
                       "智算中心"],
        },
        "mkt": {
            "high": ["数字经济示范区", "数字化转型", "公共数据开放",
                     "数据资产"],
            "medium": ["数字政府", "智慧城市", "数据资产入表",
                       "数据交易"],
        },
        "cap": {
            "high": ["科创板", "数字经济产业基金", "数据资产入表"],
            "medium": ["数字经济", "数字化转型基金", "数据资产融资"],
        },
    },
    # ---- 新能源 ----
    "新能源": {
        "tech": {
            "high": ["光伏", "风电", "氢能", "储能", "碳捕集",
                     "新能源材料"],
            "medium": ["钙钛矿", "钠离子电池", "固态电池", "绿氢",
                       "核电"],
        },
        "prod": {
            "high": ["电网接入", "碳配额", "绿色制造", "源网荷储"],
            "medium": ["新型电力系统", "充换电", "新能源汽车", "绿电"],
        },
        "mkt": {
            "high": ["储能补贴", "碳交易", "绿证", "新能源汽车下乡"],
            "medium": ["碳市场", "CCER", "新能源", "可再生能源"],
        },
        "cap": {
            "high": ["绿色债券", "碳金融", "ESG", "新能源产业基金"],
            "medium": ["绿色信贷", "碳中和债券", "新能源基金"],
        },
    },
    # ---- 制造业 ----
    "制造业": {
        "tech": {
            "high": ["智能制造", "数字化改造", "技改资金", "工业互联网",
                     "核心技术国产替代"],
            "medium": ["技术改造", "设备更新", "工业母机", "高端装备",
                       "首台套"],
        },
        "prod": {
            "high": ["工业用地", "能耗指标", "环评审批", "供应链稳定",
                     "安全生产"],
            "medium": ["产能置换", "绿色制造", "节能降碳", "产业园区"],
        },
        "mkt": {
            "high": ["首台套", "首批次", "保险补偿", "政府采购",
                     "出口退税"],
            "medium": ["产业基金", "市场准入", "品牌建设"],
        },
        "cap": {
            "high": ["专精特新", "小巨人", "北交所", "政府引导基金",
                     "技改贷款"],
            "medium": ["技改贴息", "产业基金", "制造业中长期贷款"],
        },
    },
    # ---- 新材料 ----
    "新材料": {
        "tech": {
            "high": ["关键材料国产替代", "首批次应用保险",
                     "材料基因工程"],
            "medium": ["新材料标准", "材料检测", "认证认可"],
        },
        "prod": {
            "high": ["危化品生产许可", "特种材料用地", "能耗指标单列"],
            "medium": ["安全生产许可", "环评", "特种设备"],
        },
        "mkt": {
            "high": ["下游应用验证", "军工采购资质", "示范应用推广"],
            "medium": ["新材料目录", "重点新材料", "应用验证"],
        },
        "cap": {
            "high": ["新材料产业基金", "军民融合基金", "科创板新材料"],
            "medium": ["新材料保险补偿", "新材料基金"],
        },
    },
    # ---- 高端装备 ----
    "高端装备": {
        "tech": {
            "high": ["工业母机", "高端数控机床", "工业机器人",
                     "智能机器人", "航空发动机"],
            "medium": ["高端装备", "智能制造", "精密仪器", "重型装备"],
        },
        "prod": {
            "high": ["首台套", "首批次", "装备国产化", "进口替代"],
            "medium": ["装备制造", "工业用地", "产业园区"],
        },
        "mkt": {
            "high": ["首台套保险补偿", "政府采购", "重大技术装备"],
            "medium": ["装备制造", "市场准入", "出口"],
        },
        "cap": {
            "high": ["专精特新", "小巨人", "高端装备基金", "技改贷款"],
            "medium": ["产业基金", "装备制造业贷款"],
        },
    },
}
